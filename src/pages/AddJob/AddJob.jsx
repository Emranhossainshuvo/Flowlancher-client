...
const AddJob = () => {
    return (
        <div>
            ...
            {/* <form classNameNameName='max-w-4xl mb-24mx-auto mt-10'>
                <div classNameNameName='rel'>
                    <img src="https://i.ibb.co/qYxbGP2/4273.jpg" alt="" />
                </div>
                <div classNameNameName='h-[450px] abs w-[896px] top-[300px] bg-black'>
                    <div>
                    ...
                    <div>
                        <select name="" id="">
                            ...
                            <option value="">Digital mercketing</option>
                        </select>
                    </div>
                </div>
            </form> */}
...
" id="floating_phone" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "  />
                            <label
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                            ...
                            <select className='w-full border-b-2 border-gray-300 mt-3 pb-1'> 
